    ...
    <div className="landing-fullwidth">
      ...
      <div className="sticky top-0 z-50 glass px-6 py-3" style={{ borderTop: 'none', borderLeft: 'none', borderRight: 'none', borderRadius: 0 }}>
        <div className="max-w-4xl mx-auto">
          <Link href="/" className="text-[#6B7194] text-sm flex items-center gap-1 transition-colors hover:text-[#1A1D2E] min-h-[44px] w-fit">
      ...
      <section className="relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #1A1D2E 0%, #2D3148 50%, #1A1D2E 100%)' }}>
        ...
        <div className="relative max-w-4xl mx-auto px-6 py-24 md:py-36 text-center z-10">
          ...
          <p className="text-lg md:text-xl text-white/60 mt-3" style={{ fontFamily: 'var(--font-inter)' }}>
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 mt-10 px-8 py-4 rounded-2xl btn-gold text-base"
          >
      ...
      {/* How It Works */}
      <section className="relative overflow-hidden" style={{ background: 'linear-gradient(180deg, #1A1D2E 0%, #252842 100%)' }}>
        <div className="max-w-4xl mx-auto px-6 py-20 md:py-28">
          <h2 className="text-2xl md:text-3xl font-bold text-white text-center" style={{ fontFamily: 'var(--font-inter)' }}>How It Works</h2>
          ...
          <div className="mt-14 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6 relative">
            ...
            {STEPS.map((step, i) => (
              <div key={step.number} className="flex flex-col items-center text-center relative">
                ...
                <span className="text-xs font-bold text-gradient-gold tracking-wider uppercase mb-2" style={{ background: 'linear-gradient(135deg, #F1B123, #D89A0E)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>{step.number}</span>
                <h3 className="text-lg font-bold text-white" style={{ fontFamily: 'var(--font-inter)' }}>{step.title}</h3>
              ...
              <div key={g.grade} className="glass-card card-3d flex items-center gap-4 p-4" style={{ borderRadius: '16px' }}>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-[#6B7194]">Score: {g.range}</span>
                  </div>
                  <p className="text-xs text-[#6B7194] mt-0.5">{g.description}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="bg-white py-20 md:py-28">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-2xl md:text-3xl font-bold text-[#1A1D2E] text-center" style={{ fontFamily: 'var(--font-inter)' }}>Key Features</h2>
          <p className="text-sm text-[#6B7194] text-center mt-2">Everything you need to make informed food choices</p>
      ...
      <section className="py-20 md:py-28" style={{ backgroundColor: '#F8F9FC' }}>
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-[#1A1D2E]" style={{ fontFamily: 'var(--font-inter)' }}>Powered By</h2>
          <p className="text-sm text-[#6B7194] mt-2 max-w-lg mx-auto leading-relaxed">
          ...
          <div className="mt-14 grid grid-cols-1 sm:grid-cols-3 gap-5 max-w-2xl mx-auto">
            ...
            <div className="glass-card card-3d flex flex-col items-center p-6" style={{ borderRadius: '20px' }}>
              ...
              <h3 className="text-sm font-bold text-[#1A1D2E]">Open Food Facts</h3>
              <p className="text-xs text-[#6B7194] mt-1">Global product database</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #F1B123 0%, #D89A0E 100%)' }}>
        ...
        <div className="relative max-w-4xl mx-auto px-6 py-20 md:py-24 text-center">
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 mt-8 px-8 py-4 rounded-2xl text-[#1A1D2E] font-semibold text-base transition-all hover:scale-[1.02] active:scale-[0.98]"
            style={{ background: 'white', boxShadow: '0 8px 30px rgba(0,0,0,0.15)' }}
          >
            Try DFQS Now
          </Link>
          <p className="text-xs text-white/50 mt-8" style={{ fontFamily: 'var(--font-inter)' }}>
