          ...
          >
            ...
            >
              ...
              <div style={{
                ...
                <span style={{ fontSize: '6px', fontWeight: 500, color: 'rgba(255,255,255,0.9)', letterSpacing: '0.2px', fontStyle: 'italic', lineHeight: '10px' }}>{facts[product.product_name] || product.fact}</span>
              </div>
            </div>
